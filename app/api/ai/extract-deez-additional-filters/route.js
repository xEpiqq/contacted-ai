...
1. DO NOT extract business types/categories - these are handled by another system
...
- Technology usage (website technologies, CMS, e-commerce platforms)
- Business size indicators
- Phone availability
- Email availability
- Or any other parameters in the schema that are NOT business category, industry, or location
...
If no additional parameters are identified, return:
{
  ...
  "message": "No additional filter criteria identified beyond business category, industry, and location."
}
...
export async function POST(request) {
  ...
  try {
    ...
    console.error('DEEZ Additional filters extraction error:', error);
...
async function extractAdditionalFilters(description) {
  try {
    const { object } = await generateObject({
      ...
      prompt: `Please analyze this description and extract any additional filter criteria beyond business category, industry, and location for the DEEZ US local businesses database: "${description}"`,
      temperature: 0.1
    });
