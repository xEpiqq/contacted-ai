...
export default async function Signup(props: {
  ...
  return (
    <>
      {/* Sign Up Form Section (40% width) - Dark themed */}
      <div className="w-full md:w-2/5 flex flex-col justify-center min-h-screen bg-[#212121] text-white p-10 md:p-16 lg:p-20">
        <div className="w-full max-w-sm mx-auto">
          <div className="mb-8">
            ...
            <p className="text-neutral-400">Join us and get 10,000 contacts today</p>
          </div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex flex-col h-full justify-center">
            ...
            <blockquote className="text-2xl font-medium text-white mb-8">
              Joining Contacted.ai was one of the best decisions for our business. Setting up took minutes, not days.
            </blockquote>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-neutral-400">@michaelchen</p>
              </div>
            </div>
          </div>
        </div>
